# Replace the reading and math scores because the 9th graders at Thomas High cheated
...
cheaters = school_data_complete_df.loc[(school_data_complete_df["school_name"]== "Thomas High School")
...
new_total_student_count = student_count - cheaters
...
THS_10_11_12 = school_data_complete_df.loc[(school_data_complete_df["school_name"]== "Thomas High School")
...
THS_passing_reading_math_df = student_data_df.loc[(student_data_df["reading_score"] >= 70) 
                                        & (student_data_df["math_score"] >= 70)
                                        & (student_data_df["school_name"] == "Thomas High School") 
                                        & ((student_data_df["grade"] == "10th") | (student_data_df["grade"] == "11th") | (student_data_df["grade"] == "12th"))].count()
THS_passing_reading_math_df

# Step 9. Calculate the percentage of 10th-12th grade students passing math from Thomas High School. 
THS_passing_math_percentage = THS_passing_math_df["math_score"]/THS_10_11_12 *100
THS_passing_math_percentage

# Step 10. Calculate the percentage of 10th-12th grade students passing reading from Thomas High School.
THS_passing_reading_percentage = THS_passing_reading_df["reading_score"]/THS_10_11_12 *100
THS_passing_reading_percentage

# Step 11. Calculate the overall passing percentage of 10th-12th grade from Thomas High School. 

THS_overall_passing_percentage = THS_passing_reading_math_df["student_name"]/THS_10_11_12 *100
...
new_math_scores_grade = pd.DataFrame({
                "9th": new_ninth_grade_math_scores,
               "10th": tenth_grade_math_scores,
               "11th": eleventh_grade_math_scores,
               "12th": twelfth_grade_math_scores})
new_math_scores_grade.head()

# Combine each Series for average reading scores by school into single data frame.
new_reading_scores_grade = pd.DataFrame({
                "9th": new_ninth_grade_reading_scores,
               "10th": tenth_grade_reading_scores,
               "11th": eleventh_grade_reading_scores,
               "12th": twelfth_grade_reading_scores})
new_reading_scores_grade.head()

# Format each grade column.
new_math_scores_grade["9th"] = new_math_scores_grade["9th"].map("{:.1f}".format)
new_math_scores_grade["10th"] = new_math_scores_grade["10th"].map("{:.1f}".format)
new_math_scores_grade["11th"] = new_math_scores_grade["11th"].map("{:.1f}".format)
new_math_scores_grade["12th"] = new_math_scores_grade["12th"].map("{:.1f}".format)
new_math_scores_grade = new_math_scores_grade[["9th","10th", "11th", "12th"]]

new_reading_scores_grade["9th"] = new_reading_scores_grade["9th"].map("{:.1f}".format)
new_reading_scores_grade["10th"] = new_reading_scores_grade["10th"].map("{:.1f}".format)
new_reading_scores_grade["11th"] = new_reading_scores_grade["11th"].map("{:.1f}".format)
new_reading_scores_grade["12th"] = new_reading_scores_grade["12th"].map("{:.1f}".format)
new_reading_scores_grade = new_reading_scores_grade[["9th", "10th", "11th", "12th"]]

# Remove the index.
new_math_scores_grade.index.name = None

# Display the data frame
new_math_scores_grade

## Remove the index.
new_reading_scores_grade.index.name = None

# Display the data frame
new_reading_scores_grade
