...
def get_2nd_div(search_str:str) -> dict:
    ...
    Returns a list of specific Second Division Numbers
    to be used for the lease polygon or ['ALL'] if
    the full section is to be considered.
'''
    results = {
        'lookups': [],
        'fractionals': [],
    ...
    results['lookups'] = [item for item in lookup_list if item is not None and len(item) > 0]
